...
| 例 | 内容 | 对应关系 |
|---|---|---|
| ★ ex030 | **三维有限断层滑动栅栏图**（plot3d 多边形 CPT 着色 + 3D 视点 -p160/20） | 滑动分布反演出图直配 WISP/ffipy/pyslip 产品；全脚本见该例页面 |
| ★ ex011 | **台站中心方位等距投影**（-JE + SE- 同心震心距圈 30°/60°/90°） | 接收函数/远震分析标配；全脚本见该例页面 |
| ★ ex002 | 地球内部界面 + PcP/PKiKP 射线路径（极坐标叠 basemap） | 教学/剖面示意 |
...
ex017 一般矢量场、ex029 3D 卫星 draped。5 个精读例（ex009/011/015/026/030）的完整脚本请访问上表 URL——版权归 GMT 中文社区 (CC BY-NC-SA)，本仓库只收录导航。
